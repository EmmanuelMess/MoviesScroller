...
PerpendicularShadowEffect::PerpendicularShadowEffect(QObject *parent) :
...
void PerpendicularShadowEffect::draw(QPainter* painter)
{
...
QRectF PerpendicularShadowEffect::boundingRectFor(const QRectF& rect) const
{
